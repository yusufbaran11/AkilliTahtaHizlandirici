@echo off
title Windows Debloater & Optimizer v1.1
color 0B
...
cls
echo ================================================================================
echo                   WINDOWS DEBLOATER ^& OPTIMIZER v1.1
echo ================================================================================
echo.
echo   [1] HIZLI TEMIZLIK (30 saniye)
echo   [2] DERIN TEMIZLIK (2 dakika)
echo   [3] TAM OPTIMIZASYON (3-4 dakika)
...
echo [7/8] RAM optimize ediliyor (hizli mod)...
start /min "" cmd /c "echo off & echo RAM temizleniyor..." & timeout /t 1 /nobreak >nul
...
echo [14/18] Sistem yanit suresi azaltiliyor...
reg add "HKLM\SYSTEM\CurrentControlSet\Control" /v WaitToKillServiceTimeout /t REG_SZ /d 2000 /f >nul 2>&1
echo        [OK] Sistem yanit suresi azaltildi

echo [15/18] Uygulamalar hizli kapatiliyor...
...
echo [16/18] Bildirimler minimize ediliyor...
reg add "HKCU\Software\Microsoft\Windows\CurrentVersion\PushNotifications" /v ToastEnabled /t REG_DWORD /d 0 /f >nul 2>&1
echo        [OK] Bildirimler minimize edildi

echo [17/18] OneDrive devre disi birakiliyor...
taskkill /F /IM OneDrive.exe /T 2>nul
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\OneDrive" /v DisableFileSyncNGSC /t REG_DWORD /d 1 /f >nul 2>&1
echo        [OK] OneDrive devre disi

echo [18/18] Sistem performans kaydi optimize ediliyor...
...
echo Bu islem 6-8 dakika surebilir.
echo.
pause
...
echo [RAM BILGISI]
systeminfo | findstr /C:"Toplam Fiziksel Bellek" /C:"Kullanilabilir Fiziksel Bellek" 2>nul
echo.
...
systeminfo | findstr /C:"Isletim Sistemi Adi" /C:"Sistem Turu" 2>nul
echo.

echo [CALISMA SURESI]
systeminfo | findstr /C:"Sistem Acilis Zamani" 2>nul
echo.
...
echo   - Ayda 1 kez onerilir
echo.
echo [TAVSIYELER]
echo   - Her gun: Hizli Temizlik
...
echo.
echo   S: 4 GB RAM'de calisir mi?
echo   C: EVET, dusuk RAM sistemler icin optimize edilmistir
echo.
echo ================================================================================
pause
goto MENU
